...
class AppTheme with ChangeNotifier {
  ...
  ThemeData get theme => _themeType == ThemeType.light ? lightTheme : darkTheme;
  ...
  ThemeData get lightTheme {
    return ThemeData.light().copyWith(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        selectedItemColor: Color(0xff3C4EC5),
  ...
  ThemeData get darkTheme {
    return ThemeData.dark().copyWith(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          ...
          selectedItemColor: Color(0xff069DEF),
          unselectedItemColor: Color(0xff495057),
          selectedLabelStyle: CustomTextStyle.labelMedium),
